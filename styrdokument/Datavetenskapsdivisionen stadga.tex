...
\begin{document}
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		\item Dessa stadgar eller ordlistan för styr- och principdokument kan endast ändras genom beslut av divisionsstämman med två tredjedelars majoritet vid två på varandra följande sammanträden.
